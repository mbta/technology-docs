...
- The Alerts Modernization team would be interested in using line
  diagrams to help users visualize detours and diversions. A shared
  line diagram library written in Elixir would save them considerable
  development time for this feature.
